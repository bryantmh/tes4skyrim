...
from asset_convert.havok.kf_decode import DecodedClip, decode_kf, split_root_motion
...
def convertkf(skeleton_hkx: str, kf_path: str, out_hkx: str) -> None:
    ...
    cmd = [HKXCMD, 'convertkf', to_hkxcmd_path(skeleton_hkx),
           to_hkxcmd_path(kf_path), to_hkxcmd_path(out_hkx)]
