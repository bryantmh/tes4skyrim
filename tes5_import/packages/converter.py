...
#: Opens a shop for the day; becomes TES5 unlock-at-start, as vanilla vendor packages write it.
T4_UNLOCK_DOORS_LOCATION = 0x00000100
...
_FLAG_MAP = (
    ...
    (T4_UNLOCK_DOORS_LOCATION, T5_UNLOCK_DOORS_START),
