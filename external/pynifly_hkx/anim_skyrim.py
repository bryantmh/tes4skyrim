...
def _build_anim_data_section(anim: AnimationData,
    ...
    align_to(8)  # TESConversion: was 2 — real Havok crashes on <8-aligned allocs
    nv0_class_str = rel()
    ...
    for i, evt in enumerate(ann_events):
        ...
        align_to(8)  # TESConversion: unaligned string allocs crash Havok
...
def _build_skel_data_section(skel: Skeleton,
    ...
    # Variant strings
    nv0_name_str = rel(); write_string("Merged Animation Container"); align_to(8)  # TESConversion: was 2 — real Havok crashes on <8-aligned allocs
    nv0_class_str = rel(); write_string("hkaAnimationContainer"); align_to(8)  # TESConversion: was 2 — real Havok crashes on <8-aligned allocs
    nv1_name_str = rel(); write_string("Resource Data"); align_to(8)  # TESConversion: was 2 — real Havok crashes on <8-aligned allocs
