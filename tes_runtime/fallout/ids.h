// Address Library stable IDs for everything FalloutRuntime touches: gun
// routing, the shot, the HUD counter, iron sights, gun parts and the dormant
// limb severing. The shared engine services' ids are in common/engine_ids.h.
//
...
// docs/commentary/asset_convert_falloutnv.md (#gun-graph, #dismemberment)
// and docs/commentary/tes_runtime_guns.md.
